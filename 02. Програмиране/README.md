...
[Материали](02.%20Програмиране.%20Материали.zip) |
[Задачи](02.%20Програмиране.%20Задачи.pdf) |
[Решения](02.%20Програмиране.%20Решения.zip)

## Съдържание 
1. Системи за контрол на версиите
2. [Типове данни](02.%20Типове%20данни)
3. [Масиви и Списъци](03.%20Масиви%20и%20Списъци)
4. [Методи и дебъгване](04.%20Методи%20и%20дебъгване)
5. [Символни низове](05.%20Символни%20низове)
6. [Многомерни масиви](06.%20Многомерни%20масиви)
7. [Речници и хеш таблици](07.%20Речници%20и%20хеш%20таблици)
8. [Подготовка за изпит](08.%20Подготовка%20за%20изпит)

## 1. Системи за контрол на версиите

### Въведение 
Използваме **системите за контрол на версиите** за улесняване на работата в екип. 
Кодът на проекта се съхранява в централно електронно **хранилище**. 
Води се опис на всички промени, които се съхраняват в **история на промените** и могат да бъдат извикани, прегледани и дори възстановени. 
Лесно се разрешават **конфликти**, възникнали при **сливане** на промени в проекта.
...
Лесно преобразуване на двоично число в шестнадесетично.
Всяка шестнадесетична цифра отговаря на 4 двоични цифри.
Процедурата работи двупосочно.
...
В програмирането, масивът представлява множество от елементи.
Елементите са номерирани от 0 до N-1 са от еднакъв тип.
Масивите имат фиксиран размер, който не може да бъде променян.
...
**Характеристики на сортирането на множества**
Сортираме (подреждаме) множества за по-бързо търсене на елементи в него. Основните особености на едно сортиране са:
...
Ключовете мога да бъдат думи или пък реални числа, за разлика от индексите на обикновения масив. Съдържат информация в **двойки** {**ключ** -> **стойност**}
...
Въведете масив от 4*k цели числа, сгънете го и изведете сумата от горните и долните редове (2*k цели числа):
```cs
int[] arr = Console.ReadLine().Split(' ').Select(int.Parse).ToArray();
int k = arr.Length / 4;
