...
setInterval(function () {
    $.getJSON("https://localhost:7066/api/messages/all", function (json) {
        $("#messages").empty();
...
// Part 4. Send Message
$("#send").click(function () {
    $.postJSON('https://localhost:7066/api/messages/create', { user: $("#username-choice").text(), content: $("#message").val() });
    $("#message").val(null);
});