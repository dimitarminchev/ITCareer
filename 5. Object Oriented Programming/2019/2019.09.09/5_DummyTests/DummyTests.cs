...
namespace _5_DummyTests
{
    [TestClass]
    public class DummyTests
    {
        [TestMethod]  // Тест дали чучелото губи здраве, ако е атакувано
        ...
        [TestMethod] // Тест дали мъртво чучело хвърля изключение, ако е атакувано
        ...
        [TestMethod] // Тест дали Мъртвото чучело може да даде XP
        ...
        [TestMethod] // Тест дали Живото чучело не може да даде XP
