...
[Материали](08.%20Операционни%20и%20вградени%20системи.%20Материали.zip) |
[Видео](https://youtube.com/playlist?list=PL-w_n7hgFuN3jhJvjfG5OCN_WEeh4c2j5)
...
```
Изтегли цялата програма: [Arduino.ino](Robot/Arduino.ino)

### Android
Android мобилното приложение е разработено с помоща на продукта [MIT App Inventor](http://ai2.appinventor.mit.edu/).
Изтеглете готовият пакет на мобилното приложение [Android.apk](Robot/Android.apk) и го качете на вашето Android устройство.
