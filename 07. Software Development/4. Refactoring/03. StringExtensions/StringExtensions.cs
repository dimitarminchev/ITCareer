...
{
    /// <summary>
    /// Метод за генериране на MD5 хеш суми
    /// </summary>
    /// <param name="input">Текст, който да бъде хеширан</param>
    /// <returns>Хеширан текст</returns>
    ...
    /// <summary>
    /// Конвертиране на текст в булева променлива
    /// </summary>
    /// <param name="input">Входен текст</param>
    /// <returns>Истина или лъжа</returns>
    ...
    /// <summary>
    /// Конвертиране на текст в цяло число 
    /// </summary>
    /// <param name="input">Входен текст</param>
    /// <returns>-32,768 .. 32,767</returns>
    ...
    /// </summary>
    /// <param name="input">Входен текст</param>
    /// <returns>-2,147,483,648 to 2,147,483,647</returns>
    ...
    /// </summary>
    /// <param name="input">Входен текст</param>
    /// <returns>-9,223,372,036,854,775,808 to 9,223,372,036,854,775,807</returns>
