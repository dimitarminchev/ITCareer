...
namespace Task_02.Models
{
    class Exam
    {
        ...
        public int StartHour
        {
            ...
            set
            {
                if (value >= 0 && value <= 23) startHour = value;
                else throw new Exception("Incorrect Start Hour Input");
            }
        }
        ...
        public int StartMinutes
        {
            ...
            set
            {
                if (value >= 0 && value <= 59) startMinutes = value;
                else throw new Exception("Incorrect Start Minutes Input");
            }
        }
        ...
        public int ArrivalHour
        {
            ...
            set
            {
                if (value >= 0 && value <= 23) arrivalHour = value;
                else throw new Exception("Incorrect Arrival Hour Input");
            }
        }
        ...
        public int ArrivalMinutes
        {
            ...
            set
            {
                if (value >= 0 && value <= 59) arrivalMinutes = value;
                else throw new Exception("Incorrect Arrival Minutes Input");
            }
        }
        public Exam(int sh, int sm, int ah, int am)
        {
            StartHour = sh;
            StartMinutes = sm;
            ArrivalHour = ah;
