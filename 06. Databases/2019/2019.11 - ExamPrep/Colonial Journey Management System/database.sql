...
CONSTRAINT fk_j_spaceports FOREIGN KEY(destination_spaceport_id) REFERENCES spaceports(id),
CONSTRAINT fk_j_spaceship FOREIGN KEY(spaceship_id) REFERENCES spaceships(id)
);
